...
class FinishCurrentTaskSessionUsecase
    extends UseCase<TaskSessionEntity, NoParams> {
  FinishCurrentTaskSessionUsecase({required TaskSessionRepository repository})
    : _repository = repository;

  final TaskSessionRepository _repository;

  @override
  Future<Either<Failure, TaskSessionEntity>> call(NoParams params) {
    return _repository.finishCurrentSession();
  }
}
